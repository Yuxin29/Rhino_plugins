// YuxinFirstPluginPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_ID(L"07032233-78F7-41FB-8B48-8FC70AB8BC0F");
...
RHINO_PLUG_IN_DESCRIPTION(L"YuxinFirstPlugin plug-in for Rhinoceros®");
...
// The one and only CYuxinFirstPluginPlugIn object
static class CYuxinFirstPluginPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CYuxinFirstPluginPlugIn definition
...
CYuxinFirstPluginPlugIn::CYuxinFirstPluginPlugIn()
{
	// Description:
...
const wchar_t* CYuxinFirstPluginPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CYuxinFirstPluginPlugIn::PlugInID() const
{
	// Description:
	...
	// {07032233-78F7-41FB-8B48-8FC70AB8BC0F}
...
BOOL CYuxinFirstPluginPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CYuxinFirstPluginPlugIn::OnUnloadPlugIn()
{
	// Description:
